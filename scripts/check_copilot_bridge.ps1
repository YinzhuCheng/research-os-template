...
Require-Text "$pluginRoot\scripts\research_os_copilot_server.py" "free_text_sha256"
Require-Text "$pluginRoot\scripts\research_os_copilot_server.py" "/api/question-answers"
Require-Text "$pluginRoot\scripts\research_os_copilot_server.py" "/api/confirm-next-action"
Require-Text "$pluginRoot\scripts\research_os_copilot_server.py" "session_state"
...
Require-Text "PUBLIC\copilot.html" "apiAnswersUrl"
Require-Text "PUBLIC\copilot.html" "apiConfirmUrl"
Require-Text "PUBLIC\copilot.html" "Run Monitor"
