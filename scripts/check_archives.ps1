...
Require-Text "apps\research-os-sidecar\research_os_sidecar\server.py" "/api/archive-preview"
Require-Text "apps\research-os-sidecar\research_os_sidecar\server.py" "/api/archives/create"
Require-Text "apps\research-os-sidecar\research_os_sidecar\archive_service.py" "archive_index.jsonl"
