...
Require-Text "PUBLIC\copilot.html" "Natural-Language UI Goal"
Require-Text "PUBLIC\copilot.html" "final papers default to English"
Require-Text "PUBLIC\copilot.html" "api/intake"
Require-Text "PUBLIC\copilot.html" "api/archive-snapshot"
Require-Text "PUBLIC\copilot.html" "phasebar"
Require-Text "PUBLIC\copilot.html" "action-groups"
Require-Text "PUBLIC\copilot.html" "finalProductPanel"
Require-Text "PUBLIC\copilot.html" "archivePanel"
Require-Text "PUBLIC\copilot.html" "loop_plan_alignment"
