...
Require-Text "AGENTS.md" "semi_automated_research_loop"
Require-Text "AGENTS.md" "loop_acceptance_gate"
Require-Text "AGENTS.md" "final_product_selection"
Require-Text "AGENTS.md" "natural-language free-form"
...
Require-Text "docs\process-contract.md" "research-os-final-product"
Require-Text "docs\process-contract.md" "loop_acceptance_gate"
