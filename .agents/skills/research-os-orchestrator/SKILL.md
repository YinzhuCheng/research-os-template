...
3. Route:
   ...
   - desktop material intake: use `research-os-copilot` for pending `CONTROL/intake_queue/` packets, `.rosproj` desktop interactions, exactly three targeted questions, and initialization reports;
